...
mod LizInventory {
    ...
    impl LizInventoryImpl of super::ILizInventory<ContractState> {
        fn add_stock(ref self: ContractState, product: felt252, new_stock: u32 ) {
            ...
            let amount: u32 = self.inventory.read(product);
            self.inventory.write(product, new_stock + amount);
        ...
        fn purchase(ref self: ContractState, product: felt252, quantity: u32 ) {
            ...
            let amount: u32 = self.inventory.read(product) - quantity;
            self.inventory.write(product, amount);

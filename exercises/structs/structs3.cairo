...
impl PackageImpl of PackageTrait {
    ...
    {
    /// Something goes here...
        // let cents_per_gram_felt252: felt252 = cents_per_gram ;
        let test: felt252 = cents_per_gram.into();
        let test2: usize = self.weight_in_grams.try_into().unwrap();
        test2 * cents_per_gram
    }
}
